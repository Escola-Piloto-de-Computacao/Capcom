   ...
   return (
      <div className="pt-20" id="Home">
         ...
         <div className="pt-28" id="Bemvindo">
            ...
            <div className="lg:grid lg:grid-cols-6 mt-10 lg:mt-16 px-[2rem] lg:px-24 gap-32">
               <div className="lg:col-span-3">
                  <img src={welcomepic} alt="" className="hidden lg:block"></img>
               </div>
               <div className="lg:col-span-3 flex items-center text-lg text-justify">
